...
## Calcs
### Mito proportion threshold
which(s02.cell.meta$mitoProp > 0.28) # No cells exceed 0.28 mito genes proportion

## Libsize vs Detected genes correlation
with(s02.cell.meta, cor.test(nReads, nGenes)) # Check correlation (0.9850)
...
## Deleted spots
length(s02@cell_ID$cell) - length(s02.filtered@cell_ID$cell) # 240 deleted spots

### Visualization plot
s02.spots.plot <- spatPlot2D(s02, cell_color = ("lightgrey"), point_size = 2,
                            select_cells = s02.filtered@cell_ID$cell, # Kept spots
                            other_cell_color = "red3", other_point_size = 2, # Mark deleted spots
                            title = "Deleted spots (sample 1)"); s02.spots.plot
...
## Calcs
### Mito proportion threshold
which(s03.cell.meta$mitoProp > 0.28) # No cells exceed 0.28 mito genes proportion

## Libsize vs Detected genes correlation
with(s03.cell.meta, cor.test(nReads, nGenes)) # Check correlation (0.9850)
...
ggsave("./project/outcomes/LPs03_metrics.png", plot = s03.metric.plots, scale = 2, width = 1920, height = 1080, units = "px")
...
## Deleted spots
length(s03@cell_ID$cell) - length(s03.filtered@cell_ID$cell) # 240 deleted spots

### Visualization plot
s03.spots.plot <- spatPlot2D(s03, cell_color = ("lightgrey"), point_size = 2,
                            select_cells = s03.filtered@cell_ID$cell, # Kept spots
                            other_cell_color = "red3", other_point_size = 2, # Mark deleted spots
                            title = "Deleted spots (sample 1)"); s03.spots.plot
ggsave("./project/outcomes/LPs03_deleted.png", plot = s03.spots.plot, scale = 2.5, width = 1920, height = 1080, units = "px")
...
## Calcs
### Mito proportion threshold
which(s04.cell.meta$mitoProp > 0.28) # No cells exceed 0.28 mito genes proportion

## Libsize vs Detected genes correlation
with(s04.cell.meta, cor.test(nReads, nGenes)) # Check correlation (0.9850)
...
ggsave("./project/outcomes/LPs04_metrics.png", plot = s04.metric.plots, scale = 2, width = 1920, height = 1080, units = "px")
...
s04.spots.plot <- spatPlot2D(s04, cell_color = ("lightgrey"), point_size = 2,
                            ...
                            other_cell_color = "red3", other_point_size = 2, # Mark deleted spots
                            title = "Deleted spots (sample 1)"); s04.spots.plot
ggsave("./project/outcomes/LPs04_deleted.png", plot = s04.spots.plot, scale = 2.5, width = 1920, height = 1080, units = "px")
...
## Libsize vs Detected genes correlation
with(s05.cell.meta, cor.test(nReads, nGenes)) # Check correlation (0.9850)
...
ggsave("./project/outcomes/LPs05_metrics.png", plot = s05.metric.plots, scale = 2, width = 1920, height = 1080, units = "px")
...
## Deleted spots
length(s05@cell_ID$cell) - length(s05.filtered@cell_ID$cell) # 240 deleted spots

### Visualization plot
s05.spots.plot <- spatPlot2D(s05, cell_color = ("lightgrey"), point_size = 2,
                            select_cells = s05.filtered@cell_ID$cell, # Kept spots
                            other_cell_color = "red3", other_point_size = 2, # Mark deleted spots
                            title = "Deleted spots (sample 1)"); s05.spots.plot
ggsave("./project/outcomes/LPs05_deleted.png", plot = s05.spots.plot, scale = 2.5, width = 1920, height = 1080, units = "px")
...
## Calcs
### Mito proportion threshold
which(s06.cell.meta$mitoProp > 0.28) # No cells exceed 0.28 mito genes proportion

## Libsize vs Detected genes correlation
with(s06.cell.meta, cor.test(nReads, nGenes)) # Check correlation (0.9850)
...
ggsave("./project/outcomes/LPs06_metrics.png", plot = s06.metric.plots, scale = 2, width = 1920, height = 1080, units = "px")
...
## Deleted spots
length(s06@cell_ID$cell) - length(s06.filtered@cell_ID$cell) # 240 deleted spots

### Visualization plot
s06.spots.plot <- spatPlot2D(s06, cell_color = ("lightgrey"), point_size = 2,
                            select_cells = s06.filtered@cell_ID$cell, # Kept spots
                            other_cell_color = "red3", other_point_size = 2, # Mark deleted spots
                            title = "Deleted spots (sample 1)"); s06.spots.plot
ggsave("./project/outcomes/LPs06_deleted.png", plot = s06.spots.plot, scale = 2.5, width = 1920, height = 1080, units = "px")
...
## Calcs
### Mito proportion threshold
which(s07.cell.meta$mitoProp > 0.28) # No cells exceed 0.28 mito genes proportion

## Libsize vs Detected genes correlation
with(s07.cell.meta, cor.test(nReads, nGenes)) # Check correlation (0.9850)
...
ggsave("./project/outcomes/LPs07_metrics.png", plot = s07.metric.plots, scale = 2, width = 1920, height = 1080, units = "px")
...
## Deleted spots
length(s07@cell_ID$cell) - length(s07.filtered@cell_ID$cell) # 240 deleted spots

### Visualization plot
s07.spots.plot <- spatPlot2D(s07, cell_color = ("lightgrey"), point_size = 2,
                            select_cells = s07.filtered@cell_ID$cell, # Kept spots
                            other_cell_color = "red3", other_point_size = 2, # Mark deleted spots
                            title = "Deleted spots (sample 1)"); s07.spots.plot
ggsave("./project/outcomes/LPs07_deleted.png", plot = s07.spots.plot, scale = 2.5, width = 1920, height = 1080, units = "px")
...
## Calcs
### Mito proportion threshold
which(s08.cell.meta$mitoProp > 0.28) # No cells exceed 0.28 mito genes proportion

## Libsize vs Detected genes correlation
with(s08.cell.meta, cor.test(nReads, nGenes)) # Check correlation (0.9850)
...
ggsave("./project/outcomes/LPs08_metrics.png", plot = s08.metric.plots, scale = 2, width = 1920, height = 1080, units = "px")
...
## Deleted spots
length(s08@cell_ID$cell) - length(s08.filtered@cell_ID$cell) # 240 deleted spots

### Visualization plot
s08.spots.plot <- spatPlot2D(s08, cell_color = ("lightgrey"), point_size = 2,
                            select_cells = s08.filtered@cell_ID$cell, # Kept spots
                            other_cell_color = "red3", other_point_size = 2, # Mark deleted spots
                            title = "Deleted spots (sample 1)"); s08.spots.plot
ggsave("./project/outcomes/LPs08_deleted.png", plot = s08.spots.plot, scale = 2.5, width = 1920, height = 1080, units = "px")
...
## Calcs
### Mito proportion threshold
which(s09.cell.meta$mitoProp > 0.28) # No cells exceed 0.28 mito genes proportion

## Libsize vs Detected genes correlation
with(s09.cell.meta, cor.test(nReads, nGenes)) # Check correlation (0.9850)
...
ggsave("./project/outcomes/LPs09_metrics.png", plot = s09.metric.plots, scale = 2, width = 1920, height = 1080, units = "px")
...
## Deleted spots
length(s09@cell_ID$cell) - length(s09.filtered@cell_ID$cell) # 240 deleted spots

### Visualization plot
s09.spots.plot <- spatPlot2D(s09, cell_color = ("lightgrey"), point_size = 2,
                            select_cells = s09.filtered@cell_ID$cell, # Kept spots
                            other_cell_color = "red3", other_point_size = 2, # Mark deleted spots
                            title = "Deleted spots (sample 1)"); s09.spots.plot
ggsave("./project/outcomes/LPs09_deleted.png", plot = s09.spots.plot, scale = 2.5, width = 1920, height = 1080, units = "px")
...
## Calcs
### Mito proportion threshold
which(s10.cell.meta$mitoProp > 0.28) # No cells exceed 0.28 mito genes proportion

## Libsize vs Detected genes correlation
with(s10.cell.meta, cor.test(nReads, nGenes)) # Check correlation (0.9850)
...
ggsave("./project/outcomes/LPs10_metrics.png", plot = s10.metric.plots, scale = 2, width = 1920, height = 1080, units = "px")
...
## Deleted spots
length(s10@cell_ID$cell) - length(s10.filtered@cell_ID$cell) # 240 deleted spots

### Visualization plot
s10.spots.plot <- spatPlot2D(s10, cell_color = ("lightgrey"), point_size = 2,
                            select_cells = s10.filtered@cell_ID$cell, # Kept spots
                            other_cell_color = "red3", other_point_size = 2, # Mark deleted spots
                            title = "Deleted spots (sample 1)"); s10.spots.plot
ggsave("./project/outcomes/LPs10_deleted.png", plot = s10.spots.plot, scale = 2.5, width = 1920, height = 1080, units = "px")
...
## Calcs
### Mito proportion threshold
which(s11.cell.meta$mitoProp > 0.28) # No cells exceed 0.28 mito genes proportion

## Libsize vs Detected genes correlation
with(s11.cell.meta, cor.test(nReads, nGenes)) # Check correlation (0.9850)
...
ggsave("./project/outcomes/LPs11_metrics.png", plot = s11.metric.plots, scale = 2, width = 1920, height = 1080, units = "px")
...
## Deleted spots
length(s11@cell_ID$cell) - length(s11.filtered@cell_ID$cell) # 240 deleted spots

### Visualization plot
s11.spots.plot <- spatPlot2D(s11, cell_color = ("lightgrey"), point_size = 2,
                            select_cells = s11.filtered@cell_ID$cell, # Kept spots
                            other_cell_color = "red3", other_point_size = 2, # Mark deleted spots
                            title = "Deleted spots (sample 1)"); s11.spots.plot
ggsave("./project/outcomes/LPs11_deleted.png", plot = s11.spots.plot, scale = 2.5, width = 1920, height = 1080, units = "px")
...
## Calcs
### Mito proportion threshold
which(s12.cell.meta$mitoProp > 0.28) # No cells exceed 0.28 mito genes proportion

## Libsize vs Detected genes correlation
with(s12.cell.meta, cor.test(nReads, nGenes)) # Check correlation (0.9850)
...
ggsave("./project/outcomes/LPs12_metrics.png", plot = s12.metric.plots, scale = 2, width = 1920, height = 1080, units = "px")
...
## Deleted spots
length(s12@cell_ID$cell) - length(s12.filtered@cell_ID$cell) # 240 deleted spots

### Visualization plot
s12.spots.plot <- spatPlot2D(s12, cell_color = ("lightgrey"), point_size = 2,
                            select_cells = s12.filtered@cell_ID$cell, # Kept spots
                            other_cell_color = "red3", other_point_size = 2, # Mark deleted spots
                            title = "Deleted spots (sample 1)"); s12.spots.plot
ggsave("./project/outcomes/LPs12_deleted.png", plot = s12.spots.plot, scale = 2.5, width = 1920, height = 1080, units = "px")
...
## Calcs
### Mito proportion threshold
which(s13.cell.meta$mitoProp > 0.28) # No cells exceed 0.28 mito genes proportion

## Libsize vs Detected genes correlation
with(s13.cell.meta, cor.test(nReads, nGenes)) # Check correlation (0.9850)
...
ggsave("./project/outcomes/LPs13_metrics.png", plot = s13.metric.plots, scale = 2, width = 1920, height = 1080, units = "px")
...
## Deleted spots
length(s13@cell_ID$cell) - length(s13.filtered@cell_ID$cell) # 240 deleted spots

### Visualization plot
s13.spots.plot <- spatPlot2D(s13, cell_color = ("lightgrey"), point_size = 2,
                            select_cells = s13.filtered@cell_ID$cell, # Kept spots
                            other_cell_color = "red3", other_point_size = 2, # Mark deleted spots
                            title = "Deleted spots (sample 1)"); s13.spots.plot
ggsave("./project/outcomes/LPs13_deleted.png", plot = s13.spots.plot, scale = 2.5, width = 1920, height = 1080, units = "px")
...
## Calcs
### Mito proportion threshold
which(s14.cell.meta$mitoProp > 0.28) # No cells exceed 0.28 mito genes proportion

## Libsize vs Detected genes correlation
with(s14.cell.meta, cor.test(nReads, nGenes)) # Check correlation (0.9850)
...
ggsave("./project/outcomes/LPs14_metrics.png", plot = s14.metric.plots, scale = 2, width = 1920, height = 1080, units = "px")
...
## Deleted spots
length(s14@cell_ID$cell) - length(s14.filtered@cell_ID$cell) # 240 deleted spots

### Visualization plot
s14.spots.plot <- spatPlot2D(s14, cell_color = ("lightgrey"), point_size = 2,
                            select_cells = s14.filtered@cell_ID$cell, # Kept spots
                            other_cell_color = "red3", other_point_size = 2, # Mark deleted spots
                            title = "Deleted spots (sample 1)"); s14.spots.plot
ggsave("./project/outcomes/LPs14_deleted.png", plot = s14.spots.plot, scale = 2.5, width = 1920, height = 1080, units = "px")
...
## Libsize vs Detected genes correlation
with(s15.cell.meta, cor.test(nReads, nGenes)) # Check correlation (0.9850)
...
ggsave("./project/outcomes/LPs15_metrics.png", plot = s15.metric.plots, scale = 2, width = 1920, height = 1080, units = "px")
...
## Deleted spots
length(s15@cell_ID$cell) - length(s15.filtered@cell_ID$cell) # 240 deleted spots

### Visualization plot
s15.spots.plot <- spatPlot2D(s15, cell_color = ("lightgrey"), point_size = 2,
                            select_cells = s15.filtered@cell_ID$cell, # Kept spots
                            other_cell_color = "red3", other_point_size = 2, # Mark deleted spots
                            title = "Deleted spots (sample 1)"); s15.spots.plot
ggsave("./project/outcomes/LPs15_deleted.png", plot = s15.spots.plot, scale = 2.5, width = 1920, height = 1080, units = "px")
...
## Calcs
### Mito proportion threshold
which(s16.cell.meta$mitoProp > 0.28) # No cells exceed 0.28 mito genes proportion

## Libsize vs Detected genes correlation
with(s16.cell.meta, cor.test(nReads, nGenes)) # Check correlation (0.9850)
...
ggsave("./project/outcomes/LPs16_metrics.png", plot = s16.metric.plots, scale = 2, width = 1920, height = 1080, units = "px")
...
## Deleted spots
length(s16@cell_ID$cell) - length(s16.filtered@cell_ID$cell) # 240 deleted spots

### Visualization plot
s16.spots.plot <- spatPlot2D(s16, cell_color = ("lightgrey"), point_size = 2,
                            select_cells = s16.filtered@cell_ID$cell, # Kept spots
                            other_cell_color = "red3", other_point_size = 2, # Mark deleted spots
                            title = "Deleted spots (sample 1)"); s16.spots.plot
ggsave("./project/outcomes/LPs16_deleted.png", plot = s16.spots.plot, scale = 2.5, width = 1920, height = 1080, units = "px")
...
## Calcs
### Mito proportion threshold
which(s17.cell.meta$mitoProp > 0.28) # No cells exceed 0.28 mito genes proportion

## Libsize vs Detected genes correlation
with(s17.cell.meta, cor.test(nReads, nGenes)) # Check correlation (0.9850)
...
ggsave("./project/outcomes/LPs17_metrics.png", plot = s17.metric.plots, scale = 2, width = 1920, height = 1080, units = "px")
...
s17.spots.plot <- spatPlot2D(s17, cell_color = ("lightgrey"), point_size = 2,
                            ...
                            other_cell_color = "red3", other_point_size = 2, # Mark deleted spots
                            title = "Deleted spots (sample 1)"); s17.spots.plot
ggsave("./project/outcomes/LPs17_deleted.png", plot = s17.spots.plot, scale = 2.5, width = 1920, height = 1080, units = "px")
...
## Calcs
### Mito proportion threshold
which(s18.cell.meta$mitoProp > 0.28) # No cells exceed 0.28 mito genes proportion

## Libsize vs Detected genes correlation
with(s18.cell.meta, cor.test(nReads, nGenes)) # Check correlation (0.9850)
...
ggsave("./project/outcomes/LPs18_metrics.png", plot = s18.metric.plots, scale = 2, width = 1920, height = 1080, units = "px")
...
## Deleted spots
length(s18@cell_ID$cell) - length(s18.filtered@cell_ID$cell) # 240 deleted spots

### Visualization plot
s18.spots.plot <- spatPlot2D(s18, cell_color = ("lightgrey"), point_size = 2,
                            select_cells = s18.filtered@cell_ID$cell, # Kept spots
                            other_cell_color = "red3", other_point_size = 2, # Mark deleted spots
                            title = "Deleted spots (sample 1)"); s18.spots.plot
ggsave("./project/outcomes/LPs18_deleted.png", plot = s18.spots.plot, scale = 2.5, width = 1920, height = 1080, units = "px")
